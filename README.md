...
DISC is an algorithm for image classification tasks, which adaptively discovers and removes spurious correlations during model training, using a concept bank generated by Stable Diffusion. 
