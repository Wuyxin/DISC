...
# Mixup
srun -p jamesz -G 1 --cpus-per-gpu=2 python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --lr 0.001 --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 300  --gamma 0.1 --generalization_adjustment 0 --lisa_mix_up --log_every 5 --root_dir $ROOT/cub --save_best --save_last --log_dir $ROOT/logs/lisa
# CutMix
...
srun -p jamesz -G 1 --cpus-per-gpu=2  --time=1-00:00:00 python run_expt.py -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 300  --gamma 0.1 --generalization_adjustment 0 --intervene --root_dir $ROOT/cub --pretrained_model_path $ROOT/logs/ERM/train/last_model.pth --concept_bank_path $ROOT/logs/ERM/concept_bank/last_model_0.1_75.pkl --log_dir $ROOT/logs/Intervene/train/alpha=1-k=10-mlp --topk 10 --alpha 1 --lr 0.0001 --save_best --save_last
