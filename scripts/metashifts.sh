...
GROUP=2
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --cpus-per-gpu=2 --time=1-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/pro-xlr-n_clusters=3-topk=5-seed=1 --root_dir $ROOT/metashifts/MetaDatasetCatDog --intervene_pro --n_clusters 3 --concept_bank_path $ROOT/logs/metashifts/ERM/syn-concept_bank/last_model_0.1_75.pkl --topk 5 --lr 0.0005 --save_best --save_last --mix_ent --syn --pretrained_model_path $ROOT/logs/metashifts/ERM/train/last_model.pth --seed 1


-C GPU_BRD:TESLA 
#pro
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --mem 64GB --cpus-per-gpu=2 --time=1-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/pro-n_clusters=5-topk=10-variance-c=5-lr=5e-4 --root_dir $ROOT/metashifts/MetaDatasetCatDog --intervene_pro --n_clusters 5 --concept_bank_path $ROOT/logs/metashifts/group_$GROUP/ERM/syn-concept_bank/last_model_0.1_75.pkl --topk 10 --lr 0.0005 --save_best --save_last --variance --c_variance 5 --mix_ent --syn --pretrained_model_path $ROOT/logs/metashifts/group_$GROUP/ERM/train/last_model.pth

#grad, no variance
GROUP=3
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --mem 64GB --cpus-per-gpu=2 --time=1-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/default-xlr-std-grad_pro-n_clusters=3-topk=10 --root_dir $ROOT/metashifts/MetaDatasetCatDog --intervene_grad_pro --n_clusters 3 --concept_bank_path $ROOT/logs/metashifts/group_$GROUP/ERM/syn-concept_bank/last_model_0.1_75.pkl --topk 10 --lr 0.0005 --save_best --save_last --syn --mix_ent --pretrained_model_path $ROOT/logs/metashifts/group_$GROUP/ERM/last_model.pth 
...
GROUP=3
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --mem 64GB --cpus-per-gpu=2 --time=1-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/default-grad_updates-n_clusters=3-topk=10 --root_dir $ROOT/metashifts/MetaDatasetCatDog --intervene_grad_updates --n_clusters 3 --concept_bank_path $ROOT/logs/metashifts/group_$GROUP/ERM/syn-concept_bank/last_model_0.1_75.pkl --topk 10 --lr 0.0005 --save_best --save_last --syn --mix_ent --pretrained_model_path $ROOT/logs/metashifts/group_$GROUP/ERM/last_model.pth 
...
NUM=100
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --mem 32GB --cpus-per-gpu=2 --time=3-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/final-absent-n_clusters=3-topk=10_umap_${NUM}_everything-seed=$SEED --root_dir $ROOT/data/metashifts/MetaDatasetCatDog --intervene_grad_reset --n_clusters 3 --concept_bank_path $ROOT/logs/metashifts/group_$GROUP/ERM/syn-concept_bank_100_absent/last_model_0.1_100.pkl --topk 10 --lr 0.0005 --save_best --save_last --syn --mix_ent --pretrained_model_path $ROOT/logs/metashifts/group_$GROUP/ERM/last_model.pth --seed $SEED --num_concept_img $NUM 
...
NUM=500
ROOT=/oak/stanford/groups/jamesz/shirwu/Owl
srun -p jamesz -G 1 --mem 32GB --cpus-per-gpu=2 --time=3-00:00:00 python run_expt.py -s confounder -d MetaDatasetCatDog -t cat -c background --batch_size 16 --weight_decay 0.0001 --model resnet50 --n_epochs 100 --gamma 0.1 --dog_group $GROUP --log_dir $ROOT/logs/metashifts/group_$GROUP/Owl/final-n_clusters=3-topk=10_umap_${NUM}_everything-seed=$SEED --root_dir $ROOT/data/metashifts/MetaDatasetCatDog --intervene_grad_reset --n_clusters 3 --concept_bank_path $ROOT/logs/metashifts/group_$GROUP/ERM/syn-concept_bank_$NUM/last_model_0.1_400.pkl --topk 10 --lr 0.0005 --save_best --save_last --syn --mix_ent --pretrained_model_path $ROOT/logs/metashifts/group_$GROUP/ERM/last_model.pth --seed $SEED --num_concept_img $NUM 
